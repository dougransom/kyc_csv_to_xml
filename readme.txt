...
Step 3:  Optional -  Install Python
...
Step6:
	...
	kyc_csv_to_adobe_xml.exe name-of-your-kyc-csv-file name-of-your-address-file

	or if you installed Python, 
	
	python kyc_csv_to_adobe_xml.py name-of-your-kyc-csv-file name-of-your-address-file
